...
class ORMFixture:
    ...
    def get_contacts_in_group(self, group):
        ...
        filter(lambda c: c.deprecated is None, orm_group.contacts)
    ...
    @db_session
    def get_group_where_contact(self, contact):
        orm_group = list(select(c for c in ORMFixture.ORMContact if c.id == contact.id))[0]
